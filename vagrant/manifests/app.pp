...
import 'config_sql.class.pp'

Class['params']->Class['package_base']->Class['package_dev_tools']->Class['package_app_server']->Class['package_phpunit']->Class['config_app_server']->Class['config_sql']
